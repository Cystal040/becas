...
<body class="fondo">
    <div class="contenedor">
        ...
        <table style="width:100%;border-collapse:collapse;">
            <tr style="text-align:left;border-bottom:1px solid #eee;padding:8px 0;">
                <th>Documento</th>
                <th>Estado</th>
                <th>Fecha</th>
                <th>Acción</th>
                ...
                <tr style="border-bottom:1px solid #f3f3f3;">
                    ...
                    <td style="padding:10px 6px">
                        ...
                        <?php else: ?>
                            ...
                            elseif ($st === 'pendiente')
                                echo '<span style="color:#f1c40f">🟡 En revisión</span>';
                            elseif ($st === 'rechazado')
                                echo '<span style="color:#c0392b">❌ Rechazado</span>';
                            else
                    ...
                    <td style="padding:10px 6px">
                        ...
                        <?php else: ?>
                            <?php if (!empty($info['ruta_archivo'])): ?>
                                <a class="btn-secundario" href="../<?php echo htmlspecialchars($info['ruta_archivo']); ?>"
                                    target="_blank">Ver</a>
                            <?php endif; ?>
